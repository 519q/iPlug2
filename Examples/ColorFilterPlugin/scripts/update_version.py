...
def main():
  ...
  plistpath = scriptpath + "/resources/ColorFilterPlugin-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ColorFilterPlugin-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/ColorFilterPlugin-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/ColorFilterPlugin-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/ColorFilterPlugin-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/ColorFilterPlugin.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/ColorFilterPlugin.iss",inplace=1):
