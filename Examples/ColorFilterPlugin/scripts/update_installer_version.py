...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=ColorFilterPlugin Demo Installer\n"
      else:
        line="OutputBaseFilename=ColorFilterPlugin Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the ColorFilterPlugin Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the ColorFilterPlugin installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=ColorFilterPlugin Demo installer\n"
     else:
       line="SetupWindowTitle=ColorFilterPlugin installer\n"
